...
// SVG → bitmap via the shared Image+canvas decoder. Inline createImageBitmap
// on an SVG blob without intrinsic dimensions throws; this path is safe.
import { decodeImageBitmap as fetchBitmap } from '../utils/decodeImageBitmap.ts';
